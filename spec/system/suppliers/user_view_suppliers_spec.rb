...
describe 'Usuário vê fornecedores' do
  ...
  it 'com sucesso' do
    # Arrange
    Supplier.create!(corporate_name: 'Beats Bebidas Mistas LTDA', brand_name: 'Beats', registration_number: '612596515755', address: 'Avenida das Pocs, 616', city: 'São Paulo', state: 'SP', email: 'sac-loja@beatsoficial.com.br')

    Supplier.create!(corporate_name: 'Fateixa Confeccoes LTDA', brand_name: 'Estilo Feitiço', registration_number: '23743693000108', address: 'Avenida João Pessoa, 5252', city: 'Fortaleza', state: 'CE', email: 'contato@dell.com')

    Supplier.create!(corporate_name: 'Dell Technologies LTDA', brand_name: 'Dell', registration_number: '7165192185127', address: 'Avenida da Emancipação, 5000', city: 'Hortolandia', state: 'SP', email: 'contato@dell.com')
